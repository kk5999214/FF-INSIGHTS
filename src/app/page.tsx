...
import { Search, Shield, Cpu, ArrowRight, Activity, Mail, User, MessageSquare, Database, Target, Zap } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white selection:bg-cyan-500/30">
                ...
                <div className="max-w-2xl mx-auto bg-gradient-to-b from-white/5 to-transparent border border-white/10 rounded-3xl p-10 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
                    ...
                    <form className="space-y-6">
                        <div className="relative">
                            ...
                            <input type="text" placeholder="Your Designation" className="w-full bg-black/50 border border-white/10 rounded-xl pl-12 pr-4 py-4 text-white outline-none focus:border-cyan-400 transition-colors capitalize" />
                        </div>
                        <div className="relative">
                            <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-neutral-500" />
                            <input type="email" placeholder="Secure Email Channel" className="w-full bg-black/50 border border-white/10 rounded-xl pl-12 pr-4 py-4 text-white outline-none focus:border-cyan-400 transition-colors capitalize" />
                        </div>
                        <textarea placeholder="Transmit Message..." rows={5} className="w-full bg-black/50 border border-white/10 rounded-xl px-5 py-4 text-white outline-none focus:border-cyan-400 transition-colors resize-none capitalize" />
                        <button type="button" className="w-full bg-white hover:bg-cyan-400 text-black font-bold py-4 rounded-xl transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(0,255,255,0.4)] capitalize">
                            Send Transmission
                        </button>
                    </form>
                </div>
            ...
            <footer className="bg-[#050505] pt-16 pb-12 px-6 border-t border-white/5 text-center relative z-10">
                ...
                <p className="text-white font-medium text-sm mb-4 capitalize">© 2026 Free Fire API Hub. All Rights Reserved.</p>
